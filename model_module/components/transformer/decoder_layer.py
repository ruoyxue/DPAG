...
class DecoderLayer(nn.Module):
    ...
    def forward(self, tgt, tgt_mask, memory, memory_mask, cache=None, vis=False):
        ...
        if vis:
            _, att_scores = self.self_attn(tgt_q, tgt, tgt, tgt_q_mask, rtn_attn=True)
        ...
        if vis:
            _, att_scores2 = self.src_attn(x, memory, memory, memory_mask, rtn_attn=True)
            return {
                "decoder_mask_att": att_scores,
                "decoder_cross_att": att_scores2
            }
