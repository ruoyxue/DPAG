...
try:
    ...
    class PlotAttentionReport(extension.Extension):
        ...
        Args:
            att_vis_fn (model.auto_avsr.nets.*_backend.e2e_asr.E2E.calculate_all_attentions):
                Function of attention visualization.
            data (list[tuple(str, dict[str, list[Any]])]): List json utt key items.
            outdir (str): Directory to save figures.
            converter (model.auto_avsr.asr.*_backend.asr.CustomConverter):
...
try:
    ...
    class PlotCTCReport(extension.Extension):
        ...
        Args:
            ctc_vis_fn (model.auto_avsr.nets.*_backend.e2e_asr.E2E.calculate_all_ctc_probs):
...
def parse_hypothesis(hyp, char_list):
    ...
    return text, tokenid_as_list, score
...
def add_results_to_json(nbest_hyps, char_list):
    ...
    # parse hypothesis
    rec_text, _, _ = parse_hypothesis(nbest_hyps[0], char_list)
    return rec_text
