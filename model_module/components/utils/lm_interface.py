...
from model_module.components.utils.scorer_interface import ScorerInterface
from model_module.components.utils.dynamic_import import dynamic_import
from model_module.components.utils.fill_missing_args import fill_missing_args


class LMInterface(ScorerInterface):
    """LM Interface for model.auto_avsr model implementation."""
    ...
    def build(cls, n_vocab: int, **kwargs):
        ...
        from model_module.auto_avsr.bin.lm_train import get_parser
...
predefined_lms = {
    "pytorch": {
        "default": "model_module.components.lm.default:DefaultRNNLM",
        "seq_rnn": "model_module.components.lm.seq_rnn:SequentialRNNLM",
        "transformer": "model_module.components.lm.transformer:TransformerLM",
    },
    "chainer": {"default": "model_module.components.lm:DefaultRNNLM"},
}
