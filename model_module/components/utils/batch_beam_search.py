...
from model_module.components.utils.beam_search import BeamSearch, Hypothesis
...
class BatchBeamSearch(BeamSearch):
    ...
    def search(self, running_hyps: BatchHypothesis, x: torch.Tensor) -> BatchHypothesis:
        ...
        # see also https://github.com/model.auto_avsr/model.auto_avsr/pull/1402#discussion_r354561029
        # update hyps
        best_hyps = []
