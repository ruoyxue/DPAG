...
from model_module.components.utils.nets_utils import to_device
...
class CTC(torch.nn.Module):
    ...
    :param bool use_linear: use a linear lay to project dim from eprojs to odim
    """

    def __init__(self, odim, eprojs, dropout_rate, ctc_type="builtin", reduce=True, use_linear=True):
        super().__init__()
        ...
        if self.ctc_type == "builtin":
            ...
            from model_module.auto_avsr.nets.pytorch_backend.gtn_ctc import GTNCTCLossFunction
